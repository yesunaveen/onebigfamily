...
<div class="fieldcontain ${hasErrors(bean: parishionerInstance, field: 'parish', 'error')} ">
	<label for="parish">
		<g:message code="parishioner.parish.label" default="Parish" />
		
	</label>
	<g:select id="parish" name="parish.id" from="${org.obf.core.Parish.list()}" optionKey="id" value="${parishionerInstance?.parish?.id}" class="many-to-one" noSelection="['null': '']"/>

</div>

<div class="fieldcontain ${hasErrors(bean: parishionerInstance, field: 'cemetry', 'error')} ">
	<label for="cemetry">
		<g:message code="parishioner.cemetry.label" default="Cemetry" />
		
	</label>
	<g:select id="cemetry" name="cemetry.id" from="${org.obf.core.Parish.list()}" optionKey="id" value="${parishionerInstance?.cemetry?.id}" class="many-to-one" noSelection="['null': '']"/>

</div>

<div class="fieldcontain ${hasErrors(bean: parishionerInstance, field: 'parishOfBirth', 'error')} ">
	<label for="parishOfBirth">
		<g:message code="parishioner.parishOfBirth.label" default="Parish Of Birth" />
		
	</label>
	<g:select id="parishOfBirth" name="parishOfBirth.id" from="${org.obf.core.Parish.list()}" optionKey="id" value="${parishionerInstance?.parishOfBirth?.id}" class="many-to-one" noSelection="['null': '']"/>

</div>

<div class="fieldcontain ${hasErrors(bean: parishionerInstance, field: 'parishOfBaptism', 'error')} ">
	<label for="parishOfBaptism">
		<g:message code="parishioner.parishOfBaptism.label" default="Parish Of Baptism" />
		
	</label>
	<g:select id="parishOfBaptism" name="parishOfBaptism.id" from="${org.obf.core.Parish.list()}" optionKey="id" value="${parishionerInstance?.parishOfBaptism?.id}" class="many-to-one" noSelection="['null': '']"/>

</div>

<div class="fieldcontain ${hasErrors(bean: parishionerInstance, field: 'parishOfConfirmation', 'error')} ">
	<label for="parishOfConfirmation">
		<g:message code="parishioner.parishOfConfirmation.label" default="Parish Of Confirmation" />
		
	</label>
	<g:select id="parishOfConfirmation" name="parishOfConfirmation.id" from="${org.obf.core.Parish.list()}" optionKey="id" value="${parishionerInstance?.parishOfConfirmation?.id}" class="many-to-one" noSelection="['null': '']"/>

</div>

<div class="fieldcontain ${hasErrors(bean: parishionerInstance, field: 'parishOfCommunion', 'error')} ">
	<label for="parishOfCommunion">
		<g:message code="parishioner.parishOfCommunion.label" default="Parish Of Communion" />
		
	</label>
	<g:select id="parishOfCommunion" name="parishOfCommunion.id" from="${org.obf.core.Parish.list()}" optionKey="id" value="${parishionerInstance?.parishOfCommunion?.id}" class="many-to-one" noSelection="['null': '']"/>

</div>

<div class="fieldcontain ${hasErrors(bean: parishionerInstance, field: 'parishOfAnointing', 'error')} ">
	<label for="parishOfAnointing">
		<g:message code="parishioner.parishOfAnointing.label" default="Parish Of Anointing" />
		
	</label>
	<g:select id="parishOfAnointing" name="parishOfAnointing.id" from="${org.obf.core.Parish.list()}" optionKey="id" value="${parishionerInstance?.parishOfAnointing?.id}" class="many-to-one" noSelection="['null': '']"/>

</div>

<div class="fieldcontain ${hasErrors(bean: parishionerInstance, field: 'parishOfDeath', 'error')} ">
	<label for="parishOfDeath">
		<g:message code="parishioner.parishOfDeath.label" default="Parish Of Death" />
		
	</label>
	<g:select id="parishOfDeath" name="parishOfDeath.id" from="${org.obf.core.Parish.list()}" optionKey="id" value="${parishionerInstance?.parishOfDeath?.id}" class="many-to-one" noSelection="['null': '']"/>
